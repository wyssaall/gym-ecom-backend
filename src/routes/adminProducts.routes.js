...
import { createProduct, deleteProduct, getAllProducts, getOneProduct, getProductsByCategory, updateProduct, updateProductsCategory } from '../controllers/products.controller.js';
...
productsAdminRouter.patch('/bulk-category', updateProductsCategory);
